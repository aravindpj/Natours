    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', 'Error: cannot logout this time');
        case 10:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          response = _context.sent;
          if (response.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Your account is created');
            window.setTimeout(function () {
              location.assign('/');
            }, 2500);
          }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXJhdmluZDEyNDUiLCJhIjoiY2xjcHV4a292MXU4aDN2cnk5MTk5dTlzbiJ9.FF96jZewZZ3iaYaIs2ZG7w';
...
var updateSetting = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          url = type === 'password' ? 'http://localhost:7000/api/v1/users/updatePassword' : 'http://localhost:7000/api/v1/users/updateMe';
          _context.prev = 1;
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51MQ9g8SD65j4T1RFf0OFdOINFt4olRgbmfvnR0QL60VKB2OFfQdTnuKEhZEuf1JscqkqCQwQo1ZTbawxUJbOWSMq00Rxw6ZFAz'); // 1) get check out session from API
          _context.next = 4;
...
var userPasswordUpdate = document.querySelector('.form-user-settings');
var bookNow = document.getElementById('book-now');
function scrollToTop() {
  var tourSection = document.getElementsByTagName("BODY")[0];
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return (0, _updateSettings.updateSetting)(form, 'data');
          case 7:
            setTimeout(function () {
              location.reload();
            }, 2000);
...
if (userPasswordUpdate) {
  userPasswordUpdate.addEventListener('submit', /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            formInputs = _toConsumableArray(new FormData(this));
            data = Object.fromEntries(formInputs);
            _context2.next = 6;
            return (0, _updateSettings.updateSetting)(data, 'password');
          case 6:
...
if (bookNow) {
  bookNow.addEventListener('click', /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            console.log(tourId);
            _context3.next = 5;
            return (0, _stripe.booking)(tourId);
          case 5:
